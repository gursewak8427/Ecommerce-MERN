...
function VManage() {
    ...
    const deleteCat = (index, catId) => {
        let isOk = confirm("Products also delete under this category, Please Confirm to delete");
        if (isOk) {
            dispatch({
                type: 'SET_LOADING'
            })
    ...
    const deleteSubCat = (index, subCatId) => {
        let isOk = confirm("Products also delete under this sub-category, Please Confirm to delete");
        if (isOk) {
            dispatch({
                type: 'SET_LOADING'
            })
